...
class Source(relations.Source): # pylint: disable=too-many-public-methods
    ...
    INSERT = relations_mysql.INSERT
    SELECT = relations_mysql.SELECT
    UPDATE = relations_mysql.UPDATE
    DELETE = relations_mysql.DELETE
